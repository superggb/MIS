...
<div class="content-w3ls">
    <div class="form-w3ls">
        <form action="/confirmeditabs/${abs.aid}" method="post">
            <div class="content-wthree1">

                <div class="grid-agileits1">
                    <div class="form-control">
                        <label class="header">员工工号 <span>*</span></label>
                        <input type="text" id="name" name="eid" value="${abs.eid}" required="">
                    </div>
                    <div class="form-control">
                    ...
                    <div class="form-control">
                        ...
                        <textarea id="message" name="reason">${abs.description}</textarea>
                    </div>
                </div>
            </div>
            <div class="w3ls-btn">
